...
while run:
    ...
    if results.multi_hand_landmarks:
        ...
        if event.type == pygame.KEYUP:
            if index_dist<30 and direction_command == 0:
                direction_command = direction
            if middle_dist<30 and direction_command == 1:
                direction_command = direction
            if  ring_dist<30 and direction_command == 2:
                direction_command = direction
            if pinky_dist<30 and direction_command == 3:
                direction_command = direction    
